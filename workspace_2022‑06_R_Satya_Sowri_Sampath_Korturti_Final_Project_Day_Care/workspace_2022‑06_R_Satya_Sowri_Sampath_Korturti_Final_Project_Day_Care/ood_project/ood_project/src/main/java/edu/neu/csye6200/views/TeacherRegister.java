...
public class TeacherRegister extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ...
        teacher.setFirst_Name(jTextField1.getText());
        teacher.setLast_Name(jTextField2.getText());
        String phone = jTextField3.getText();
        // Boolean inValidflag=false;

            teacher.setPhnNo(jTextField3.getText());
            teacher.setPhnNo(jTextField3.getText());
            teacher.setAddres(jTextArea1.getText());
